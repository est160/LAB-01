...
## บันทึกผลการทดลอง
  ...
  https://drive.google.com/file/d/0B2dq2HMXOOglUXVhcUpFY2lXVHM/view?usp=sharing
  จากการทดลองโปรแกรมหลังจากพิมพ์คำสั่งตามตัวอย่าง เมื่อกด ctrl+f5 จะได้ MessageBox เป็นกล่องข้อความตอบโต้ขึ้นมา ว่า
  Hello World! This is my first win32 program!
...
```
   จากผลการทดลองเปลี่ยนจะได้กล่องข้อความตอบสนองทางหน้าจอดังนี้
   https://drive.google.com/file/d/0B2dq2HMXOOgldHNUZmM0RThHTEE/view?usp=sharing
   https://drive.google.com/file/d/0B2dq2HMXOOglcjNKTUJ4ZE5KUEk/view?usp=sharing
   https://drive.google.com/file/d/0B2dq2HMXOOglTkVsVWNlVlprVDQ/view?usp=sharing
   https://drive.google.com/file/d/0B2dq2HMXOOglR0ZGeUlhU3lucVk/view?usp=sharing
